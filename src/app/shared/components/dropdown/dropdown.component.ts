...
@Component({
	...
	standalone: true,
	imports: [CommonModule, FormsModule, ReactiveFormsModule, FloatLabelModule, DropdownModule],
	template: `
		<div class="form__group relative py-3" [formGroup]="formGroup">
			<span class="p-float-label relative">
				...
				<label for="{{ label }}" style="font-size: 12px">{{ placeholder }}</label>
			</span>
			@if (isInvalid) {
